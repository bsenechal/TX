...
INSERT INTO `avatar` (`content`) VALUES (RAWTOHEX('Test1'))(RAWTOHEX('Test2'));
UNLOCK TABLES;
...
INSERT INTO `deal_picture` (`content`) VALUES (RAWTOHEX('Image1:testhex')),(RAWTOHEX('Image2:testhex'));
UNLOCK TABLES;
...
INSERT INTO `tag` VALUES (1,1),(1,2),(2,1);
UNLOCK TABLES;
